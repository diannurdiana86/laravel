...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @can('user/create')
                <a href="{{ route('auth.users.create') }}" class="btn btn-success btn-sm my-2"><i class="bi bi-plus-circle"></i>
                    Add New User</a>
            @endcan
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('auth.users.destroy', $user->id) }}" method="post">
                                    ...
                                    <a href="{{ route('auth.users.show', $user->id) }}" class="btn btn-warning btn-sm"><i
